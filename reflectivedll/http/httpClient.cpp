...
std::wstring makeHttpREGISTERRequest(std::wstring fqdn, int port, std::wstring uri, bool useTLS, std::wstring payload){
...
int wmain(int argc,  wchar_t* argv[]){
    ...
    if (useTLS == 1){
     ...
     std::wcout << makeHttpREGISTERRequest(fqdn,  port, uri, tls, payload) << std::endl;
    return 0;
